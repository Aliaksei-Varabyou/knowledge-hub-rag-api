...
function removeFromArray<T, K extends keyof T>(data: T[], field: K): Omit<T, K>[] {
...
export function removeField<T, K extends keyof T>(data: T | T[] | undefined, field: K): Omit<T, K> | Omit<T, K>[] | undefined {
